<x-guest-layout>
    ...
    <h1 class="text-3xl text-center mt-4">Login</h1>
    <form method="POST" action="{{ route('login') }}">
        ...
        <a class="underline ms-4 text-sm text-blue-600 hover:text-blue-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" href="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4 p-4">
            ...
            <x-primary-button class="ml-3 bg-blue-500 hover:bg-blue-600 text-white">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
